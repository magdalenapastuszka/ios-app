...
enum ImagePickerCollectionViewFlowLayoutSpacingMode {
    case fixed(spacing: CGFloat)
    case overlap(visibleOffset: CGFloat)
}

enum ImagePickerCollectionViewFlowLayoutAnimation {
...
final class ImagePickerCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    var spacingMode = ImagePickerCollectionViewFlowLayoutSpacingMode.fixed(spacing: 0)
    var animationMode = ImagePickerCollectionViewFlowLayoutAnimation.scale(sideItemScale: 0.7, sideItemAlpha: 0.6, sideItemShift: 0.0)
...
private extension ImagePickerCollectionViewFlowLayout {
